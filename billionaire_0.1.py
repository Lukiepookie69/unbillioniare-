...
print()
print(Color.RED + "BILLIONAIRE" + Color.END)
print()


if string_checker(Color.YELLOW + "Do you want to read the instructions? (y/n): ", 1, yes_no_list) == "yes":
    print(Color.BLUE + "You have 3 days to turn a thousand into a billion dollars")
    print("It's your goal to find a way to turn a thousand into a billion dollars by either buying items, gambling, or donating")
    print()
...
while days > 0:
    if days == 1:
        print(Color.YELLOW + "You have " + str(days) + " day to earn $1,000,000,000. You have $" + comma_add(money)+".")
    else:
        print(Color.YELLOW + "You have " + str(days) + " days to earn $1,000,000,000. You have $" + comma_add(money)+".")
